...
settings = npy.loadtxt( "settings_1.txt", dtype = float )
d_data = npy.loadtxt( "data.txt", dtype = float ) #digital data (0-255)
...
ax.plot( datatime, a_data, marker = 's', markersize = 6, markeredgecolor = "red", markevery = 20, color = "black", alpha = 1, linewidth = 0.2, linestyle = "--", label = "V=V(t)" )
ax.legend()
